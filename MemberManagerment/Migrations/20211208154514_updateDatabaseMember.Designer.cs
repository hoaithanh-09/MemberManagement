...
namespace MemberManagement.Data.Migrations
{
    ...
    [Migration("20211208154514_updateDatabaseMember")]
    partial class updateDatabaseMember
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemberManagement.Data.Entities.ActivityMember", b =>
                {
            ...
            modelBuilder.Entity("MemberManagement.Data.Entities.FundGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MemberManagement.Data.Entities.ActivityMember", b =>
                {
                    b.HasOne("MemberManagement.Data.Entities.Member", "Activity")
                        .WithMany("ActivityMembers")
                        .HasForeignKey("ActivityId")
                        .HasConstraintName("FK__ActivityM__Activ__3B75D760")
                        .IsRequired();

                    b.HasOne("MemberManagement.Data.Entities.Activity", "Member")
                        .WithMany("ActivityMembers")
